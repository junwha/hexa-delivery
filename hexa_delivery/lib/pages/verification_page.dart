...
① < HeXA밥시켜유 >은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.

② < HeXA밥시켜유 >은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
...
본 약관은 “밥시켜유” 모바일 애플리케이션에서 제공하는 서비스(이하 “서비스”라 함)를 이용함에 있어 “밥시켜유”와 이용자의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.

제2조 (정의)

① “밥시켜유”란 회사가 “서비스”를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역(이하 “재화 등”이라 함)을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 “밥시켜유”를 운영하는 사업자의 의미로도 사용합니다.

② “밥시켜유서비스”란 모바일 애플리케이션을 통해 이용자가 원하는 배달을 다른 사람과 함께 시킬 수 있도록 하는 것을 기본으로 하되 채팅, 모임 생성 등 “밥시켜유” 모바일 애플리케이션 상의 제공 서비스 전체를 의미합니다.

③ “이용자”란 “밥시켜유”에 접속하여 본 약관에 따라 밥시켜유가 제공하는 서비스를 받는 회원을 말합니다.

④ “회원”이라 함은 “밥시켜유”에 개인정보를 제공하여 회원등록을 한 자로서, “밥시켜유”의 정보를 지속적으로 제공받으며, “밥시켜유”가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.

⑤ “가게”란 밥시켜유에서 정보를 제공하는 음식점을 말하며, 회사의 대리인이나 피용자로 간주되지 아니합니다.
